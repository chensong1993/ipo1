...
import com.ccb.lfh.retrofittwo.Api.NewsApi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Retrofit retrofit=new Retrofit.Builder()
               ...
               .addConverterFactory(GsonConverterFactory.create())
                .build();
       NewsApi server=retrofit.create(NewsApi.class);
        Call<NewList> call=server.getNews("toutiao");
        ...
        call.enqueue(new Callback<NewList>() {
            ...
            public void onFailure(Call<NewList> call, Throwable t) {
                Toast.makeText(NewsActivity.this, "请求错误"+call.toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
